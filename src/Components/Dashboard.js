...
const Dashboard = () => {
  ...
  return (
    <div style={{ width: '100%', height: '100vh', display: 'flex', backgroundColor: 'white', backgroundImage: `url(${loginImage})`, backgroundSize: 'cover', backgroundPosition: 'center', alignItems: 'center', justifyContent: 'center', }}>
      <div className='divContainer' style={{ display: 'flex', width: '60%', height: '56%', borderRadius: '20px', background: 'rgba(135,206,250, 0.15)' }}>
        ...
        <div style={{ flex: 1, paddingTop: '3%', marginRight: '12%'}}>
          <div>
            <Space>
              <Button type='link' style={{ color: 'black', fontSize:'16px' }} onClick={() => setCurrentAccess('User')}>USER</Button>
              <Button type='link' style={{ color: 'black', fontSize:'16px' }} onClick={() => setCurrentAccess('Doctor')}>DOCTOR</Button>
              <Button type='link' style={{ color: 'black', fontSize:'16px' }} onClick={() => setCurrentAccess('Admin')}>ADMIN</Button>
            </Space>
          </div>
